    ...
    <v-row>
      <v-col cols="6">
        <div>
          ...
          <br>
          <h4>
            Hi! I am a Computer Science student with a focused interest on software engineering. I am currently working on my Bachelors at the University of Buffalo.
          </h4>
          <br>
          <h4>
